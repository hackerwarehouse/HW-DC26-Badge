...
const tChar defaultFont_array[] = {
  ...
  // character: ' '
  {0x20, &defaultFont_0x20},

  // character: '!'
  {0x21, &defaultFont_0x21},

  // character: '"'
  {0x22, &defaultFont_0x22},

  // character: '#'
  {0x23, &defaultFont_0x23},

  // character: '$'
  {0x24, &defaultFont_0x24},

  // character: '%'
  {0x25, &defaultFont_0x25},

  // character: '&'
  {0x26, &defaultFont_0x26},

  // character: '''
  {0x27, &defaultFont_0x27},

  // character: '('
  {0x28, &defaultFont_0x28},

  // character: ')'
  {0x29, &defaultFont_0x29},

  // character: '*'
  {0x2a, &defaultFont_0x2a},

  // character: '+'
  {0x2b, &defaultFont_0x2b},

  // character: ','
  {0x2c, &defaultFont_0x2c},

  // character: '-'
  {0x2d, &defaultFont_0x2d},

  // character: '.'
  {0x2e, &defaultFont_0x2e},

  // character: '/'
  {0x2f, &defaultFont_0x2f},

  // character: '0'
  {0x30, &defaultFont_0x30},

  // character: '1'
  {0x31, &defaultFont_0x31},

  // character: '2'
  {0x32, &defaultFont_0x32},

  // character: '3'
  {0x33, &defaultFont_0x33},

  // character: '4'
  {0x34, &defaultFont_0x34},

  // character: '5'
  {0x35, &defaultFont_0x35},

  // character: '6'
  {0x36, &defaultFont_0x36},

  // character: '7'
  {0x37, &defaultFont_0x37},

  // character: '8'
  {0x38, &defaultFont_0x38},

  // character: '9'
  {0x39, &defaultFont_0x39},

  // character: ':'
  {0x3a, &defaultFont_0x3a},

  // character: ';'
  {0x3b, &defaultFont_0x3b},

  // character: '<'
  {0x3c, &defaultFont_0x3c},

  // character: '='
  {0x3d, &defaultFont_0x3d},

  // character: '>'
  {0x3e, &defaultFont_0x3e},

  // character: '?'
  {0x3f, &defaultFont_0x3f},

  // character: '\x0040'
  {0x40, &defaultFont_0x40},

  // character: 'A'
  {0x41, &defaultFont_0x41},

  // character: 'B'
  {0x42, &defaultFont_0x42},

  // character: 'C'
  {0x43, &defaultFont_0x43},

  // character: 'D'
  {0x44, &defaultFont_0x44},

  // character: 'E'
  {0x45, &defaultFont_0x45},

  // character: 'F'
  {0x46, &defaultFont_0x46},

  // character: 'G'
  {0x47, &defaultFont_0x47},

  // character: 'H'
  {0x48, &defaultFont_0x48},

  // character: 'I'
  {0x49, &defaultFont_0x49},

  // character: 'J'
  {0x4a, &defaultFont_0x4a},

  // character: 'K'
  {0x4b, &defaultFont_0x4b},

  // character: 'L'
  {0x4c, &defaultFont_0x4c},

  // character: 'M'
  {0x4d, &defaultFont_0x4d},

  // character: 'N'
  {0x4e, &defaultFont_0x4e},

  // character: 'O'
  {0x4f, &defaultFont_0x4f},

  // character: 'P'
  {0x50, &defaultFont_0x50},

  // character: 'Q'
  {0x51, &defaultFont_0x51},

  // character: 'R'
  {0x52, &defaultFont_0x52},

  // character: 'S'
  {0x53, &defaultFont_0x53},

  // character: 'T'
  {0x54, &defaultFont_0x54},

  // character: 'U'
  {0x55, &defaultFont_0x55},

  // character: 'V'
  {0x56, &defaultFont_0x56},

  // character: 'W'
  {0x57, &defaultFont_0x57},

  // character: 'X'
  {0x58, &defaultFont_0x58},

  // character: 'Y'
  {0x59, &defaultFont_0x59},

  // character: 'Z'
  {0x5a, &defaultFont_0x5a},

  // character: '['
  {0x5b, &defaultFont_0x5b},

  // character: '\'
  {0x5c, &defaultFont_0x5c},

  // character: ']'
  {0x5d, &defaultFont_0x5d},

  // character: '^'
  {0x5e, &defaultFont_0x5e},

  // character: '_'
  {0x5f, &defaultFont_0x5f},

  // character: '`'
  {0x60, &defaultFont_0x60},

  // character: 'a'
  {0x61, &defaultFont_0x61},

  // character: 'b'
  {0x62, &defaultFont_0x62},

  // character: 'c'
  {0x63, &defaultFont_0x63},

  // character: 'd'
  {0x64, &defaultFont_0x64},

  // character: 'e'
  {0x65, &defaultFont_0x65},

  // character: 'f'
  {0x66, &defaultFont_0x66},

  // character: 'g'
  {0x67, &defaultFont_0x67},

  // character: 'h'
  {0x68, &defaultFont_0x68},

  // character: 'i'
  {0x69, &defaultFont_0x69},

  // character: 'j'
  {0x6a, &defaultFont_0x6a},

  // character: 'k'
  {0x6b, &defaultFont_0x6b},

  // character: 'l'
  {0x6c, &defaultFont_0x6c},

  // character: 'm'
  {0x6d, &defaultFont_0x6d},

  // character: 'n'
  {0x6e, &defaultFont_0x6e},

  // character: 'o'
  {0x6f, &defaultFont_0x6f},

  // character: 'p'
  {0x70, &defaultFont_0x70},

  // character: 'q'
  {0x71, &defaultFont_0x71},

  // character: 'r'
  {0x72, &defaultFont_0x72},

  // character: 's'
  {0x73, &defaultFont_0x73},

  // character: 't'
  {0x74, &defaultFont_0x74},

  // character: 'u'
  {0x75, &defaultFont_0x75},

  // character: 'v'
  {0x76, &defaultFont_0x76},

  // character: 'w'
  {0x77, &defaultFont_0x77},

  // character: 'x'
  {0x78, &defaultFont_0x78},

  // character: 'y'
  {0x79, &defaultFont_0x79},

  // character: 'z'
  {0x7a, &defaultFont_0x7a},

  // character: '{'
  {0x7b, &defaultFont_0x7b},

  // character: '|'
  {0x7c, &defaultFont_0x7c},

  // character: '}'
  {0x7d, &defaultFont_0x7d},

  // character: '~'
  {0x7e, &defaultFont_0x7e},

  // character: '°'
  {0xb0, &defaultFont_0xb0}
